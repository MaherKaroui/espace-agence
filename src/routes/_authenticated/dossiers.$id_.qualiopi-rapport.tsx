...
export const Route = createFileRoute("/_authenticated/dossiers/$id_/qualiopi-rapport")({
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 print:p-0 space-y-4 print:space-y-2">
      <div className="flex items-center justify-between gap-3 print:hidden">
        <Link to="/dossiers/$id" params={{ id }} className="text-sm text-muted-foreground flex items-center gap-1 hover:text-foreground">
