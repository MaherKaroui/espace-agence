...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Espace Client — Plateforme Agence" },
      ...
      { property: "og:title", content: "Espace Client — Plateforme Agence" },
      { property: "og:description", content: "Gérez vos dossiers et échangez avec votre agence en toute sécurité." },
